/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: e6975a9914607bf42ccda23de0337079)
// Runtime types generated with workerd@1.20260921.1 2026-09-15
interface __BaseEnv_Env {
	CACHE: KVNamespace;
	CLIENT_LIMITER: RateLimit;
	ARCHIVE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	ENVIRONMENT: string;
	VERSION: string;
	CONTACT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "VERSION" | "CONTACT">> {}
}
